<template>
  <div class="el-new-tree__item" v-show="node.visible">
    <!-- 节点内容 start -->
    <section
      class="el-new-tree__content"
      :class="{
        'el-new-tree--expanded': node.expanded,
        'el-new-tree--selected': node.selected,
        'el-new-tree--disabled': !selectable
      }"
      :style="contentStyle"
      @click="onSelect"
    >
      <i
        ...
        class="el-new-tree__expand-icon el-icon-caret-right"
      ...
      />
      <span v-else class="el-new-tree__label">{{ label }}</span>
    </section>
    <!-- 节点内容 end -->
