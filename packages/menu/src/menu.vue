...
import Menubar from 'element-nice-ui/src/utils/menu/aria-menubar';
import { addClass, removeClass, hasClass } from 'element-nice-ui/src/utils/dom';
...
export default {
  ...
  computed: {
    ...
    menuClass() {
      const classes = ['el-menu']
      this.mode === 'horizontal' && classes.push('el-menu--horizontal');
      this.collapse && classes.push('el-menu--collapse')
      ;['small', 'large', 'medium'].includes(this.size) && classes.push(`el-menu--${this.size}`)
      return classes
    }
  },
  watch: {
