<template>
  ...
  >
    ...
    >
      ...
      <slider-button
        :vertical="vertical"
        :button-value="firstValue"
        @input="onFirstValueInput"
      ...
      <slider-button
        :vertical="vertical"
        :button-value="secondValue"
        @input="onSecondValueInput"
        :tooltip-class="tooltipClass"
        ref="button2"
        v-if="range"
      >
...
import ElInputNumber from 'element-nice-ui/packages/input-number'
