...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'element-nice-ui/src/utils/date-util';
  import { hasClass } from 'element-nice-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'element-nice-ui/src/utils/util';
