...
```html
<template>
  <el-btn :plain="true" @click="open">Show message</el-btn>
...
```html
<template>
  <el-btn :plain="true" @click="openCenter">Centered text</el-btn>
</template>
...
```html
<template>
  <el-btn :plain="true" @click="openHTML">Use HTML String</el-btn>
</template>
