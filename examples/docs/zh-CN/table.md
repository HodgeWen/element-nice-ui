...
:::demo 当`el-table`元素中注入`data`对象数组后，再注入headers属性, 即可生成一个表格

```html

<template>
  <el-table :data="tableData" :headers="headers" style="width: 100%" />
</template>
...
<template>
  <el-table :data="tableData" stripe :headers="headers" style="width: 100%" />
</template>
...
<template>
  <el-table :data="tableData" :headers="headers" border style="width: 100%" />
</template>
...
```html
<template>
  <el-table :data="tableData" :headers="headers" style="width: 100%" :row-class-name="tableRowClassName" />
</template>
...
```html
<template>
  <el-table :data="tableData" height="250" :headers="headers"  border style="width: 100%">
    <span ></span>
