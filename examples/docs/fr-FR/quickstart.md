...
```javascript
import Vue from 'vue';
import ElementUI from 'element-nice-ui';
import 'element-nice-ui/lib/theme-chalk/index.css';
...
Ensuite, si vous n'avez besoin que de Btn et Select, éditez main.js comme suit:
