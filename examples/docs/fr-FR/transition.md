...
<template>
  <div>
    <el-btn @click="show = !show">Cliquez ici</el-btn>
...
<template>
  <div>
    <el-btn @click="show2 = !show2">Cliquez ici</el-btn>
...
<template>
  <div>
    <el-btn @click="show3 = !show3">Cliquez ici</el-btn>
...
```js
// fade/zoom
import 'element-nice-ui/lib/theme-chalk/base.css';
// collapse
import CollapseTransition from 'element-nice-ui/lib/transitions/collapse-transition';
import Vue from 'vue'
